...
<body>
    ...
    <div class="background">
        ...
        <div class="cari">
            <div class="container">
                <br><br>
                <h4 class="brown-text text-darken-2">Cari Berdasarkan Bahan</h4>
                <form action="Bahan.php" method="get">
                    <div class="row">
                        <div class="input-field col s12">
                            <input class="brown-text text-darken-4" id="kataKunci" name="cariResep" type="text">
                            <label for="mulai">Masukan Bahan</label>
                        </div>
                    </div>
                    <input class="btn brown darken-2" type="submit" name="bahan" value="cari" style="width:100%;">
                </form>
            </div>
        </div>
